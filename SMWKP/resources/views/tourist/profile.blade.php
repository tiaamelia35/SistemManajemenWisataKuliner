...
<nav class="fixed bottom-0 left-0 right-0 z-50 flex justify-around items-center h-16 bg-surface/95 backdrop-blur border-t border-outline-variant shadow-lg max-w-xl mx-auto w-full">
    ...
    <a href="{{ route('tourist.bookings') }}" class="flex flex-col items-center justify-center flex-1 text-secondary hover:text-primary transition-colors">
        <span class="material-symbols-outlined text-xl">book_online</span>
        <span class="text-[10px] mt-0.5">Booking</span>
    </a>
    <a href="{{ route('tourist.profile') }}" class="flex flex-col items-center justify-center flex-1 text-primary font-bold">
